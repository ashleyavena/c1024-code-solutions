...
const imageVar = '/starry-sky.jpeg';
const capVar = 'A beautiful Image of Space';
const descriptionVar = `  Lorem ipsum, dolor sit amet consectetur adipisicing elit. Aliquam incidunt
...
const buttonVar = 'Click For Next Image';
...
export default function App() {
  return (
    <>
      ...
      <Image src={imageVar} />
      <Caption text={capVar} />
      <Description text={descriptionVar} />
      <Button text={buttonVar} />
    </>
  );
}
